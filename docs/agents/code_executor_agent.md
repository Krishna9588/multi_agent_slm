...
1. Check the `agents/code_executor_agent.py` file for any hardcoded `os.environ.get()` calls to see what API keys it expects.
...
## How to Update
- The code for this agent lives in `agents/code_executor_agent.py`.
