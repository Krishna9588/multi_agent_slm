...
1. Check the `agents/deep_research_agent.py` file for any hardcoded `os.environ.get()` calls to see what API keys it expects.
...
## How to Update
- The code for this agent lives in `agents/deep_research_agent.py`.
