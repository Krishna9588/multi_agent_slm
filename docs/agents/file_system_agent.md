# File System Agent (file_system_agent.py)
...
1. Check the `agents/file_system_agent.py` file for any hardcoded `os.environ.get()` calls to see what API keys it expects.
...
## How to Update
- The code for this agent lives in `agents/file_system_agent.py`.
